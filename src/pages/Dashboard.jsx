...
const Dashboard = () => {
  ...
  const [prediction, setPrediction] = useState({
    ...
    nextMonthEstimation:
      "Menghitung proyeksi pengeluaran...",
  });
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const savedAmount = summaryData.savedAmount !== undefined ? summaryData.savedAmount : (income - expense);
  ...
  return (
    <MainLayout user={user}>
      ...
      >
        <h5 className="fw-bold text-muted mb-1">
        ...
        <div className="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
          ...
          <div className="d-flex flex-wrap gap-2 align-items-center">
            ...
            {filterMode === "preset" && (
              ...
              >
                <option value="30d-day">
                  30 Hari Terakhir
                </option>

                <option value="60d-day">
                  60 Hari Terakhir
                </option>

                <option value="90d-day">
                  90 Hari Terakhir
                </option>

                <option value="90d-month">
                  Per Bulan
                </option>
              </select>
            )}
